...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { bust: @measurement.bust, hip: @measurement.hip, waist: @measurement.waist } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { bust: @measurement.bust, hip: @measurement.hip, waist: @measurement.waist } }
